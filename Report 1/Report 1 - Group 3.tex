...
\paragraph{Hardware for comparison of all algorithms (50, 100 customers)}

\paragraph{Hardware for comparison of different cooling structures for SA (50 customers) }

\begin{itemize}
    \item \textbf{Processor:} AMD Ryzen 5 3500U with Radeon Vega Mobile Graphics (8 cores), approximately 2.1 GHz
    \item \textbf{Memory:} 8 GB RAM
    \item \textbf{Operating System:} Windows 10 Pro 64-bit (Build 19045)
    \item \textbf{DirectX Version:} DirectX 12
\end{itemize}
