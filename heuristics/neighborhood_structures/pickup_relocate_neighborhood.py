...
def compute_pickup_relocate_neighbor(solution, customers, improvement_strategy, tracker):
    """
    This function returns a neighbor of the pickup_relocate neighborhood depending on the improvement_strategy.
    (one pickup point is relocated inside a vehicle)
